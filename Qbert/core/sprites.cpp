...
namespace qbert
{
    void init_sprites()
    {
        ...
        sprite_manager::get_instance()
            ...
            .add_sprite_pair(qb_sp_level_1_yellow_cube_1, "level_1_red_cube_1")
            .add_sprite_pair(qb_sp_level_1_yellow_cube_2, "level_1_red_cube_2")
            .add_sprite_pair(qb_sp_level_1_yellow_cube_small, "level_1_red_cube_small")
            .add_sprite_pair(qb_sp_level_1_blue_cube_1, "level_1_red_cube_1")
            .add_sprite_pair(qb_sp_level_1_blue_cube_2, "level_1_red_cube_2")
            .add_sprite_pair(qb_sp_level_1_blue_cube_small, "level_1_red_cube_small")
